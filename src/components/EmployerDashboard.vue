<template>
        ...
        <div v-else class="job-listings">
          <div v-for="job in filteredJobs" :key="job._id" class="job-card">
            ...
            <div class="job-actions">
              <button class="action-link" @click="viewApplications(job._id)">
                View Applications
              </button>
              <button class="action-link" @click="editJob(job._id)">
                Edit
              </button>
  ...
  export default {
    ...
    setup() {
      ...
      // Navigate to view applications for a job
      const viewApplications = (jobId) => {
        router.push(`/job-applications/${jobId}`);
      };
  
      // Navigate to edit a job
      const editJob = (jobId) => {
